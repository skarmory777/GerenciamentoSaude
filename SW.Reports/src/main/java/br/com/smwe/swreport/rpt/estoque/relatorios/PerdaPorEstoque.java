 ...
 * @author newda
 */
public class PerdaPorEstoque extends BaseHttpServlet {
    
    private static final long serialVersionUID = 1L;

    public PerdaPorEstoque() {
        super();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String jrxml = this.GetJasperFile(contexto,"Estoque/Relatorios/RptPerdaEstoque.jasper",request.getParameter("TenancyName"));
            ...
            response.setHeader("Content-Disposition", "inline; filename=PerdaPorEstoque.pdf"); 
