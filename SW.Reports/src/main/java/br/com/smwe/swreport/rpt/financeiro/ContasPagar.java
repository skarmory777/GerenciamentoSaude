 ...
 * @author SMWE
 */
public class ContasPagar extends BaseHttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String jrxml = this.GetJasperFile(contexto,"Financeiro/RptContasPagar.jasper",request.getParameter("TenancyName"));
