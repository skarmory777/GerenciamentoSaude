 ...
 * @author newda
 */
public class ConsumoPorPaciente extends BaseHttpServlet {
    
    private static final long serialVersionUID = 1L;

    public ConsumoPorPaciente() {
        super();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String jrxml = this.GetJasperFile(contexto,"Estoque/Relatorios/RptConsumoPaciente.jasper",request.getParameter("TenancyName"));
            ...
            response.setHeader("Content-Disposition", "inline; filename=ConsumoPaciente.pdf"); 
