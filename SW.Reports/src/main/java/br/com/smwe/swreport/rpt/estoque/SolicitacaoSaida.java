...
public class SolicitacaoSaida extends BaseHttpServlet {
    
    private static final long serialVersionUID = 1L;

    public SolicitacaoSaida() {
        super();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String jrxml = this.GetJasperFile(contexto,"Estoque/SolicitacaoSaida/solicitacaoSaida.jasper",request.getParameter("TenancyName"));
