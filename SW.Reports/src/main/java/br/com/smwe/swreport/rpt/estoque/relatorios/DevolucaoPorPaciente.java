 ...
 * @author newda
 */
public class DevolucaoPorPaciente extends BaseHttpServlet {
    
    private static final long serialVersionUID = 1L;

    public DevolucaoPorPaciente() {
        super();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String jrxml = this.GetJasperFile(contexto,"Estoque/Relatorios/RptDevolucaoPaciente.jasper",request.getParameter("TenancyName"));
            ...
            parametros.put("pacienteId", request.getParameter("pacienteId"));
            ...
            response.setHeader("Content-Disposition", "inline; filename=DevolucaoEstoque.pdf"); 
