 ...
 * @author newda
 */
public class ConsumoPorSetor extends BaseHttpServlet {
    
    private static final long serialVersionUID = 1L;

    public ConsumoPorSetor() {
        super();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String jrxml = this.GetJasperFile(contexto,"Estoque/Relatorios/RptConsumoSetor.jasper",request.getParameter("TenancyName"));
            ...
            parametros.put("unidadeOrganizacionalId", request.getParameter("unidadeOrganizacionalId"));
            ...
            response.setHeader("Content-Disposition", "inline; filename=ConsumoSetor.pdf"); 
