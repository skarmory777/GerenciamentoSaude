...
public class Acuracia extends BaseHttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String jrxml = this.GetJasperFile(contexto,"Estoque/Relatorios/RptAcuracia.jasper",request.getParameter("TenancyName"));
            ...
            response.setHeader("Content-Disposition", "inline; filename=Acuracia.pdf"); 
