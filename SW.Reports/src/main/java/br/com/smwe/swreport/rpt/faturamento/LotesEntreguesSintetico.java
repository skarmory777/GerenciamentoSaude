...
public class LotesEntreguesSintetico extends BaseHttpServlet {
    
    private static final long serialVersionUID = 1L;

    public LotesEntreguesSintetico() {
        super();
    }
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String jrxml = this.GetJasperFile(contexto,"Faturamento/Relatorios/LotesEntregues_Sintetico.jasper",request.getParameter("TenancyName"));
                      
            // prepara parâmetros
            Map<String, Object> parametros = new HashMap<>();
            //Parametros do Relatório
            parametros.put("CodigoLote", request.getParameter("CodigoLote"));
            parametros.put("Convenio", request.getParameter("Convenio"));
            parametros.put("Local", request.getParameter("Local"));
            ...
            response.setHeader("Content-Disposition", "inline; filename=LotesEntregues_Sintetico.pdf"); 
