...
public class CmpRequisicao extends BaseHttpServlet {
    
    private static final long serialVersionUID = 1L;

    public CmpRequisicao() {
        super();
    }
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String jrxml = this.GetJasperFile(contexto,"Estoque/Relatorios/RptCmpRequisicao.jasper",request.getParameter("TenancyName"));
            ...
            response.setHeader("Content-Disposition", "inline; filename=RptCmpRequisicao.pdf"); 
