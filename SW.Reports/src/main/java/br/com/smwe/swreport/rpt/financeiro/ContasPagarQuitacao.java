 ...
 * @author SMWE
 */
public class ContasPagarQuitacao extends BaseHttpServlet {

    private static final long serialVersionUID = 1L;
    
    public ContasPagarQuitacao() {
        super();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String jrxml = this.GetJasperFile(contexto,"Financeiro/RptContasPagarQuitacao.jasper",request.getParameter("TenancyName"));
            ...
            response.setHeader("Content-Disposition", "inline; filename=ContasPagarQuitacao.pdf"); 
