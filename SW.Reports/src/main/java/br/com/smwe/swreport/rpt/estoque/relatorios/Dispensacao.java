...
public class Dispensacao extends BaseHttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String jrxml = this.GetJasperFile(contexto,"Estoque/Relatorios/RptDispensacao.jasper",request.getParameter("TenancyName"));
                      
            // prepara parâmetros
            Map<String, Object> parametros = new HashMap<>();
            //Parametros do Relatório
            parametros.put("UndOrganizacionalId", Integer.valueOf(request.getParameter("UndOrganizacionalId")));
            ...
            response.setHeader("Content-Disposition", "inline; filename=Dispensacao.pdf"); 
