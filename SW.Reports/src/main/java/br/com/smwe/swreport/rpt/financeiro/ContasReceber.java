 ...
 * @author SMWE
 */
public class ContasReceber extends BaseHttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String jrxml = this.GetJasperFile(contexto,"Financeiro/RptContasReceber.jasper",request.getParameter("TenancyName"));
            ...
            response.setHeader("Content-Disposition", "inline; filename=ContasReceber_"+request.getParameter("contamedicaid")+".pdf"); 
