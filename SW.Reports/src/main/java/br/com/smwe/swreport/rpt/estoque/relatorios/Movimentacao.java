 ...
 * @author gusta
 */
public class Movimentacao extends BaseHttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String jrxml = this.GetJasperFile(contexto,"Estoque/Movimentacao.jasper",request.getParameter("TenancyName"));
            ...
            parametros.put("whereCondition", request.getParameter("whereCondition"));
            ...
            response.setHeader("Content-Disposition", "inline; filename=movimentacao.pdf"); 
