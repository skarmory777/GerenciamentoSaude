...
public class CmpDetalhado extends BaseHttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String jrxml = this.GetJasperFile(contexto,"Estoque/Relatorios/RptCmpDetalhado.jasper",request.getParameter("TenancyName"));
            ...
            parametros.put("NumeroNota", request.getParameter("NumeroNota"));
            parametros.put("Estoque", request.getParameter("Estoque"));
            parametros.put("NomeFornecedor", request.getParameter("NomeFornecedor"));
            ...
            response.setHeader("Content-Disposition", "inline; filename=RptCmpDetalhado.pdf"); 
