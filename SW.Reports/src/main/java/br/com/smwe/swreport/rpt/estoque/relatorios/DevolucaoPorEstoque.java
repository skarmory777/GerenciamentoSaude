 ...
 * @author newda
 */
public class DevolucaoPorEstoque extends BaseHttpServlet {
    
    private static final long serialVersionUID = 1L;

    public DevolucaoPorEstoque() {
        super();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String jrxml = this.GetJasperFile(contexto,"Estoque/Relatorios/RptDevolucaoEstoque.jasper",request.getParameter("TenancyName"));
