 ...
 */
package br.com.smwe.swreport.rpt.financeiro;
 ...
 * @author SMWE
 */
public class ContasPagarGroupNome extends BaseHttpServlet {

    private static final long serialVersionUID = 1L;
    
    public ContasPagarGroupNome() {
        super();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String jrxml = this.GetJasperFile(contexto,"Financeiro/RptContasPagarGroupNome.jasper",request.getParameter("TenancyName"));
                      
            // prepara parâmetros
            Map<String, Object> parametros = new HashMap<>();
            //Parametros do Relatório
            parametros.put("dataInicio", request.getParameter("dataInicio"));
            parametros.put("dataFinal", request.getParameter("dataFim"));
            parametros.put("isCredito", request.getParameter("isCredito"));
            ...
            parametros.put("PessoaId", request.getParameter("pessoaId"));
            parametros.put("EmpresaId", request.getParameter("empresaId"));
            parametros.put("SituacaoLancamentoId", request.getParameter("situacaoLancamentoId"));
            ...
            response.setHeader("Content-Disposition", "inline; filename=ContasPagar_"+request.getParameter("contamedicaid")+".pdf"); 
