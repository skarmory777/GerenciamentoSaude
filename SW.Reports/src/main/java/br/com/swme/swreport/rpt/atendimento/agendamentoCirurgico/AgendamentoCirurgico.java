 ...
 */
package br.com.swme.swreport.rpt.atendimento.agendamentoCirurgico;
 ...
 * @author SMWE
 */
public class AgendamentoCirurgico extends BaseHttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String jrxml = this.GetJasperFile(contexto,"Assistencial/AgendamentoCirurgico/AgendamentoCirurgicoDetalhamento.jasper",request.getParameter("TenancyName"));
                      
            // prepara parâmetros
            Map<String, Object> parametros = new HashMap<>();
            //Parametros do Relatório
            parametros.put("DATAINICIAL", request.getParameter("DATAINICIAL"));
            ...
            response.setHeader("Content-Disposition", "inline; filename=AgendamentoCirurgico.pdf"); 
