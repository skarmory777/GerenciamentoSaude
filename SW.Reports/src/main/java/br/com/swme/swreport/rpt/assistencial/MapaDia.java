package br.com.swme.swreport.rpt.assistencial;
...
public class MapaDia extends BaseHttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String jrxml = this.GetJasperFile(contexto,"Assistencial/RptMapaDia.jasper",request.getParameter("TenancyName"));
                      
            // prepara parâmetros
            Map<String, Object> parametros = new HashMap<>();
            //Parametros do Relatório
            parametros.put("usuarioImpressao", request.getParameter("UsuarioImpressao"));
            parametros.put("unidadeId", Integer.valueOf(request.getParameter("UnidadeId")));
            parametros.put("statusId", Integer.valueOf(request.getParameter("StatusId")));
            ...
            response.setHeader("Content-Disposition", "inline; filename=RptMapaDia.pdf"); 
