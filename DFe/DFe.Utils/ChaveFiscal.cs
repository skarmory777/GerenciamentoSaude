...
namespace DFe.Utils
{
    ...
    public class ChaveFiscal
    {
        ...
        public static DadosChaveFiscal ObterChave(EstadoNfe ufEmitente, DateTime dataEmissao, string cnpjEmitente, ModeloDocumento modelo, int serie, long numero, int tipoEmissao, int cNf)
        {
