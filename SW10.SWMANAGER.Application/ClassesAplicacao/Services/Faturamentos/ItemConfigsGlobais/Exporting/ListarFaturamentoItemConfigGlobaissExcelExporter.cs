...
{
    public class ListarItemConfigGlobaisExcelExporter : EpPlusExcelExporterBase, IListarItemConfigGlobaisExcelExporter
    {
        private readonly ITimeZoneConverter _timeZoneConverter;
        private readonly IAbpSession _abpSession;

        public ListarItemConfigGlobaisExcelExporter(
        ...
        public FileDto ExportToFile(List<FaturamentoItemConfigGlobalDto> ItemConfigsDto)
        {
