...
{
    public class ListarProdutoCodigoMedicamentoExcelExporter : EpPlusExcelExporterBase, IListarProdutoCodigoMedicamentoExcelExporter
    {
        private readonly ITimeZoneConverter _timeZoneConverter;
        private readonly IAbpSession _abpSession;

        public ListarProdutoCodigoMedicamentoExcelExporter(
        ...
        public FileDto ExportToFile(List<ProdutoCodigoMedicamentoDto> produtoCodigoMedicamentoDtos)
        {
            return CreateExcelPackage(
                string.Format("ProdutosCodigosMedicamento_{0:yyyyMMdd_hhmmss}.xlsx", DateTime.Now),
                excelPackage =>
                {
                    var sheet = excelPackage.Workbook.Worksheets.Add(L("ProdutoCodigoMedicamento"));
                    ...
                    AddObjects(
                        sheet, 2, produtoCodigoMedicamentoDtos,
