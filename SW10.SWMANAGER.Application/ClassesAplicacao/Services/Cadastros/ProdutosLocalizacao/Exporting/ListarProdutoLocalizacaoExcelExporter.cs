...
{
    public class ListarProdutoLocalizacaoExcelExporter : EpPlusExcelExporterBase, IListarProdutoLocalizacaoExcelExporter
    {
        private readonly ITimeZoneConverter _timeZoneConverter;
        private readonly IAbpSession _abpSession;

        public ListarProdutoLocalizacaoExcelExporter(
        ...
        public FileDto ExportToFile(List<ProdutoLocalizacaoDto> produtoLocalizacaoDtos)
        {
            return CreateExcelPackage(
                string.Format("ProdutosLocalizacao_{0:yyyyMMdd_hhmmss}.xlsx", DateTime.Now),
                excelPackage =>
                {
                    var sheet = excelPackage.Workbook.Worksheets.Add(L("ProdutosLocalizacao"));
                    ...
                    AddObjects(
                        sheet, 2, produtoLocalizacaoDtos,
