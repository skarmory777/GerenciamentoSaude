...
{
    public class ListarProdutoGrupoTratamentoExcelExporter : EpPlusExcelExporterBase, IListarProdutoGrupoTratamentoExcelExporter
    {
        private readonly ITimeZoneConverter _timeZoneConverter;
        private readonly IAbpSession _abpSession;

        public ListarProdutoGrupoTratamentoExcelExporter(
        ...
        public FileDto ExportToFile(List<ProdutoGrupoTratamentoDto> produtoGrupoTratamentoDtos)
        {
            return CreateExcelPackage(
                string.Format("ProdutosGruposTratamento_{0:yyyyMMdd_hhmmss}.xlsx", DateTime.Now),
                excelPackage =>
                {
                    var sheet = excelPackage.Workbook.Worksheets.Add(L("ProdutosGruposTratamento"));
                    ...
                    AddObjects(
                        sheet, 2, produtoGrupoTratamentoDtos,
