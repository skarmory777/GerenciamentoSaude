...
{
    public class ListarMotivosCaucaoExcelExporter : EpPlusExcelExporterBase, IListarMotivosCaucaoExcelExporter
    {
        private readonly ITimeZoneConverter _timeZoneConverter;
        private readonly IAbpSession _abpSession;

        public ListarMotivosCaucaoExcelExporter(
        ...
        public FileDto ExportToFile(List<MotivoCaucaoDto> MotivoCaucaoDtos)
        {
            return CreateExcelPackage(
                string.Format("MotivosCaucao_{0:yyyyMMdd_hhmmss}.xlsx", DateTime.Now),
                excelPackage =>
                {
                    var sheet = excelPackage.Workbook.Worksheets.Add(L("MotivosCaucao"));
