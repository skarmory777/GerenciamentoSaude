...
{
    public class ListarProdutoAcaoTerapeuticaExcelExporter : EpPlusExcelExporterBase, IListarProdutoAcaoTerapeuticaExcelExporter
    {
        private readonly ITimeZoneConverter _timeZoneConverter;
        private readonly IAbpSession _abpSession;

        public ListarProdutoAcaoTerapeuticaExcelExporter(
        ...
        public FileDto ExportToFile(List<ProdutoAcaoTerapeuticaDto> produtoAcaoTerapeuticaDtos)
        {
            return CreateExcelPackage(
                string.Format("ProdutoAcaoTerapeutica_{0:yyyyMMdd_hhmmss}.xlsx", DateTime.Now),
                excelPackage =>
                {
                    ...
                    AddObjects(
                        sheet, 2, produtoAcaoTerapeuticaDtos,
