...
{
    public class ListarGrupoClasseExcelExporter : EpPlusExcelExporterBase, IListarGrupoClasseExcelExporter
    {
        private readonly ITimeZoneConverter _timeZoneConverter;
        private readonly IAbpSession _abpSession;

        public ListarGrupoClasseExcelExporter(
        ...
        public FileDto ExportToFile(List<GrupoClasseDto> GrupoClasseDtos)
        {
            return CreateExcelPackage(
                string.Format("GruposClasse_{0:yyyyMMdd_hhmmss}.xlsx", DateTime.Now),
                excelPackage =>
                {
                    var sheet = excelPackage.Workbook.Worksheets.Add(L("GruposClasse"));
