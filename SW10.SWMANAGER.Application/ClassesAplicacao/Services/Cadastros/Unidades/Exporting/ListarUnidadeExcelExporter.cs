...
{
    public class ListarUnidadeExcelExporter : EpPlusExcelExporterBase, IListarUnidadeExcelExporter
    {
        private readonly ITimeZoneConverter _timeZoneConverter;
        private readonly IAbpSession _abpSession;

        public ListarUnidadeExcelExporter(
        ...
        public FileDto ExportToFile(List<UnidadeDto> unidadeDtos)
        {
            return CreateExcelPackage(
                string.Format("Unidades_{0:yyyyMMdd_hhmmss}.xlsx", DateTime.Now),
                excelPackage =>
                {
                    var sheet = excelPackage.Workbook.Worksheets.Add(L("Unidades"));
