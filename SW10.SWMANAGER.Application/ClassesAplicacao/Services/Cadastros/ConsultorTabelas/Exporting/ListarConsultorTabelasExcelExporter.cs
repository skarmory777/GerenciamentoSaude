...
{
    public class ListarConsultorTabelaExcelExporter : EpPlusExcelExporterBase, IListarConsultorTabelaExcelExporter
    {
        private readonly ITimeZoneConverter _timeZoneConverter;
        private readonly IAbpSession _abpSession;

        public ListarConsultorTabelaExcelExporter(
        ...
        public FileDto ExportToFile(List<ConsultorTabelaDto> tabelaDominioDtos)
        {
