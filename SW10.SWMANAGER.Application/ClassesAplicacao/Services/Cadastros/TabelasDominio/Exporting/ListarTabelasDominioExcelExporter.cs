...
{
    public class ListarTabelaDominioExcelExporter : EpPlusExcelExporterBase, IListarTabelaDominioExcelExporter
    {
        private readonly ITimeZoneConverter _timeZoneConverter;
        private readonly IAbpSession _abpSession;

        public ListarTabelaDominioExcelExporter(
        ...
        public FileDto ExportToFile(List<TabelaDominioDto> tabelaDominioDtos)
        {
            return CreateExcelPackage(
                string.Format("TabelasDominio_{0:yyyyMMdd_hhmmss}.xlsx", DateTime.Now),
                excelPackage =>
                {
                    var sheet = excelPackage.Workbook.Worksheets.Add(L("TabelasDominio"));
