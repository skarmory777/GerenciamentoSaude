...
{
    public class ListarProdutoUnidadeExcelExporter : EpPlusExcelExporterBase, IListarProdutoUnidadeExcelExporter
    {
        private readonly ITimeZoneConverter _timeZoneConverter;
        private readonly IAbpSession _abpSession;

        public ListarProdutoUnidadeExcelExporter(
        ...
        public FileDto ExportToFile(List<ProdutoUnidadeDto> produtoUnidadeDtos)
        {
            return CreateExcelPackage(
                string.Format("ProdutosUnidade_{0:yyyyMMdd_hhmmss}.xlsx", DateTime.Now),
                excelPackage =>
                {
                    var sheet = excelPackage.Workbook.Worksheets.Add(L("ProdutosUnidade"));
