...
{
    public class ListarTipoPrestadorExcelExporter : EpPlusExcelExporterBase, IListarTipoPrestadorExcelExporter
    {
        private readonly ITimeZoneConverter _timeZoneConverter;
        private readonly IAbpSession _abpSession;

        public ListarTipoPrestadorExcelExporter(
        ...
        public FileDto ExportToFile(List<TipoPrestadorDto> tipoPrestadorDtos)
        {
            return CreateExcelPackage(
                string.Format("TiposPrestadores_{0:yyyyMMdd_hhmmss}.xlsx", DateTime.Now),
                excelPackage =>
                {
                    var sheet = excelPackage.Workbook.Worksheets.Add(L("TiposPrestadores"));
