...
{
    public class ListarTipoTabelaDominioExcelExporter : EpPlusExcelExporterBase, IListarTipoTabelaDominioExcelExporter
    {
        private readonly ITimeZoneConverter _timeZoneConverter;
        private readonly IAbpSession _abpSession;

        public ListarTipoTabelaDominioExcelExporter(
        ...
        public FileDto ExportToFile(List<TipoTabelaDominioDto> tipoTabelaDominioDtos)
        {
