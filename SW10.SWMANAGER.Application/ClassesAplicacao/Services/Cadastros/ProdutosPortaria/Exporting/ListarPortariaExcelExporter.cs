...
{
    public class ListarProdutoPortariaExcelExporter : EpPlusExcelExporterBase, IListarProdutoPortariaExcelExporter
    {
        private readonly ITimeZoneConverter _timeZoneConverter;
        private readonly IAbpSession _abpSession;

        public ListarProdutoPortariaExcelExporter(
        ...
        public FileDto ExportToFile(List<ProdutoPortariaDto> ProdutoPortariaDtos)
        {
            return CreateExcelPackage(
                string.Format("ProdutosPortaria_{0:yyyyMMdd_hhmmss}.xlsx", DateTime.Now),
                excelPackage =>
                {
                    var sheet = excelPackage.Workbook.Worksheets.Add(L("ProdutosPortaria"));
