...
{
    public class ListarMotivosTransferenciaLeitoExcelExporter : EpPlusExcelExporterBase, IListarMotivosTransferenciaLeitoExcelExporter
    {
        private readonly ITimeZoneConverter _timeZoneConverter;
        private readonly IAbpSession _abpSession;

        public ListarMotivosTransferenciaLeitoExcelExporter(
        ...
        public FileDto ExportToFile(List<MotivoTransferenciaLeitoDto> MotivoTransferenciaLeitoDtos)
        {
            return CreateExcelPackage(
                string.Format("MotivosTransferenciaLeito_{0:yyyyMMdd_hhmmss}.xlsx", DateTime.Now),
                excelPackage =>
                {
                    var sheet = excelPackage.Workbook.Worksheets.Add(L("MotivosTransferenciaLeito"));
                    ...
                    AddObjects(
                        sheet, 2, MotivoTransferenciaLeitoDtos,
