...
{
    public class ListarProdutoTipoUnidadeExcelExporter : EpPlusExcelExporterBase, IListarProdutoTipoUnidadeExcelExporter
    {
        private readonly ITimeZoneConverter _timeZoneConverter;
        private readonly IAbpSession _abpSession;

        public ListarProdutoTipoUnidadeExcelExporter(
        ...
        public FileDto ExportToFile(List<ProdutoTipoUnidadeDto> produtoTipoUnidadeDtos)
        {
            return CreateExcelPackage(
                string.Format("ProdutosTiposUnidade_{0:yyyyMMdd_hhmmss}.xlsx", DateTime.Now),
                excelPackage =>
                {
                    var sheet = excelPackage.Workbook.Worksheets.Add(L("ProdutosTiposUnidade"));
                    ...
                    AddObjects(
                        sheet, 2, produtoTipoUnidadeDtos,
