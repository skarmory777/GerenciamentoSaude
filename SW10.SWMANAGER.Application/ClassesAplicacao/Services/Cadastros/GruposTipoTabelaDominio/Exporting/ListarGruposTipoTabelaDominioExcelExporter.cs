...
{
    public class ListarGrupoTipoTabelaDominioExcelExporter : EpPlusExcelExporterBase, IListarGrupoTipoTabelaDominioExcelExporter
    {
        private readonly ITimeZoneConverter _timeZoneConverter;
        private readonly IAbpSession _abpSession;

        public ListarGrupoTipoTabelaDominioExcelExporter(
        ...
        public FileDto ExportToFile(List<GrupoTipoTabelaDominioDto> tipoTabelaDominioDtos)
        {
            return CreateExcelPackage(
                string.Format("TiposTabelaDominio_{0:yyyyMMdd_hhmmss}.xlsx", DateTime.Now),
                excelPackage =>
                {
                    var sheet = excelPackage.Workbook.Worksheets.Add(L("TiposTabelaDominio"));
