...
{
    public class ListarGrupoSubClasseExcelExporter : EpPlusExcelExporterBase, IListarGrupoSubClasseExcelExporter
    {
        private readonly ITimeZoneConverter _timeZoneConverter;
        private readonly IAbpSession _abpSession;

        public ListarGrupoSubClasseExcelExporter(
        ...
        public FileDto ExportToFile(List<GrupoSubClasseDto> GrupoSubClasseDtos)
        {
            return CreateExcelPackage(
                string.Format("SubClasses_{0:yyyyMMdd_hhmmss}.xlsx", DateTime.Now),
                excelPackage =>
                {
                    var sheet = excelPackage.Workbook.Worksheets.Add(L("SubClasses"));
