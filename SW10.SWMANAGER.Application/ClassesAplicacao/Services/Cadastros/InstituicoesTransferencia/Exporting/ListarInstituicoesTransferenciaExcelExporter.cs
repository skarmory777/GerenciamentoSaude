...
{
    public class ListarInstituicoesTransferenciaExcelExporter : EpPlusExcelExporterBase, IListarInstituicaoTransferenciaExcelExporter
    {
        private readonly ITimeZoneConverter _timeZoneConverter;
        private readonly IAbpSession _abpSession;

        public ListarInstituicoesTransferenciaExcelExporter(
        ...
        public FileDto ExportToFile(List<InstituicaoTransferenciaDto> InstituicaoTransferenciaDtos)
        {
            return CreateExcelPackage(
                string.Format("InstituicoesTransferencia_{0:yyyyMMdd_hhmmss}.xlsx", DateTime.Now),
                excelPackage =>
                {
                    var sheet = excelPackage.Workbook.Worksheets.Add(L("InstituicoesTransferencia"));
                    ...
                    AddObjects(
                        sheet, 2, InstituicaoTransferenciaDtos,
