...
{
    public class ListarProdutoSubstanciaExcelExporter : EpPlusExcelExporterBase, IListarProdutoSubstanciaExcelExporter
    {
        private readonly ITimeZoneConverter _timeZoneConverter;
        private readonly IAbpSession _abpSession;

        public ListarProdutoSubstanciaExcelExporter(
        ...
        public FileDto ExportToFile(List<ProdutoSubstanciaDto> SubstanciaDtos)
        {
            return CreateExcelPackage(
                string.Format("ProdutosSubstancia_{0:yyyyMMdd_hhmmss}.xlsx", DateTime.Now),
                excelPackage =>
                {
                    var sheet = excelPackage.Workbook.Worksheets.Add(L("Substancias"));
