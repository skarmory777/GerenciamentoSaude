...
{
    public class ListarTipoUnidadeExcelExporter : EpPlusExcelExporterBase, IListarTipoUnidadeExcelExporter
    {
        private readonly ITimeZoneConverter _timeZoneConverter;
        private readonly IAbpSession _abpSession;

        public ListarTipoUnidadeExcelExporter(
        ...
        public FileDto ExportToFile(List<TipoUnidadeDto> tipoUnidadeDtos)
        {
            return CreateExcelPackage(
                string.Format("TiposUnidade_{0:yyyyMMdd_hhmmss}.xlsx", DateTime.Now),
                excelPackage =>
                {
                    var sheet = excelPackage.Workbook.Worksheets.Add(L("TiposUnidade"));
