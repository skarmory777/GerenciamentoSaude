...
{
    public class ListarTipoAtendimentoExcelExporter : EpPlusExcelExporterBase, IListarTipoAtendimentoExcelExporter
    {
        private readonly ITimeZoneConverter _timeZoneConverter;
        private readonly IAbpSession _abpSession;

        public ListarTipoAtendimentoExcelExporter(
        ...
        public FileDto ExportToFile(List<TipoAtendimentoDto> tipoAtendimentoDtos)
        {
            return CreateExcelPackage(
                string.Format("TiposAtendimento_{0:yyyyMMdd_hhmmss}.xlsx", DateTime.Now),
                excelPackage =>
                {
                    var sheet = excelPackage.Workbook.Worksheets.Add(L("TiposAtendimento"));
                    sheet.OutLineApplyStyle = true;

                    AddHeader(
                        sheet,
                        L("CodTipoAtendimento"),
                        L("Descricao"),
                        L("CreatorUserId"),
                        L("CreationTime"),
