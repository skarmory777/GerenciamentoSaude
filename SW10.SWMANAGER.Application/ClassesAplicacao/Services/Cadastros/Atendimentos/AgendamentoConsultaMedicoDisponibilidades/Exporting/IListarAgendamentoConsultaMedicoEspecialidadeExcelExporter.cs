...
{
    public interface IListarAgendamentoConsultaMedicoDisponibilidadesExcelExporter
    {
        FileDto ExportToFile(List<AgendamentoConsultaMedicoDisponibilidadeDto> profissoesDtos);
    }
}
