...
{
    public class ListarProdutoLaboratorioExcelExporter : EpPlusExcelExporterBase, IListarProdutoLaboratorioExcelExporter
    {
        private readonly ITimeZoneConverter _timeZoneConverter;
        private readonly IAbpSession _abpSession;

        public ListarProdutoLaboratorioExcelExporter(
        ...
        public FileDto ExportToFile(List<ProdutoLaboratorioDto> produtoLaboratorioDtos)
        {
            return CreateExcelPackage(
                string.Format("ProdutosLaboratorio_{0:yyyyMMdd_hhmmss}.xlsx", DateTime.Now),
                excelPackage =>
                {
                    var sheet = excelPackage.Workbook.Worksheets.Add(L("ProdutosLaboratorio"));
                    ...
                    AddObjects(
                        sheet, 2, produtoLaboratorioDtos,
