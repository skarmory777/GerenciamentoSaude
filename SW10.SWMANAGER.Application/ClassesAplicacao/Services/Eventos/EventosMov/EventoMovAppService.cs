...
namespace SW10.SWMANAGER.ClassesAplicacao.Services.Eventos.EventosMov
{

    public class EventoMovAppService : SWMANAGERAppServiceBase, IEventoMovAppService
    {
