...
{
    public class QuitacaoContasPagarAppService : QuitacaoAppService, IQuitacaoContasPagarAppService
    {
        ...
        public QuitacaoContasPagarAppService(IRepository<Quitacao, long> quitacaoRepository
