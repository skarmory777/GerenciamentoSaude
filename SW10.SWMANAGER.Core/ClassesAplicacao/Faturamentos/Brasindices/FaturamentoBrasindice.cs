...
namespace SW10.SWMANAGER.ClassesAplicacao.Faturamentos.BrasIndices
{
    [Table("FatBrasIndice")]
    public class FaturamentoBrasIndice : CamposPadraoCRUD
    {
        [StringLength(10)]
        ...
        //[ForeignKey("GrupoId")]
        //public virtual FaturamentoGrupo Grupo { get; set; }
        //public long GrupoId { get; set; }

        //[ForeignKey("SubGrupoId")]
        //public virtual FaturamentoSubGrupo SubGrupo { get; set; }
