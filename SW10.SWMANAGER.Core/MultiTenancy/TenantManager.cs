...
using SW10.SWMANAGER.MultiTenancy.Demo;
...
namespace SW10.SWMANAGER.MultiTenancy
{
    ...
    //public interface ITenantCachesCache
    //{
    //    Tenant GetCacheItem(Tenant tenant);
    //}

    //public class TenantCaches : ITenantCachesCache, ISingletonDependency
    //{
    //    private readonly ICacheManager cacheManager;

    //    private readonly IRepository<Tenant> tenantRepository;

    //    public TenantCaches(ICacheManager cacheManager, IRepository<Tenant> tenantRepository)
    //    {
    //        this.cacheManager = cacheManager;
    //        this.tenantRepository = tenantRepository;
    //    }

    //    public Tenant GetCacheItem(Tenant tenant)
    //    {
    //        return this.cacheManager.GetCache<string, Tenant>(CacheNames.Tenant).Get(
    //            tenant.TenancyName,
    //            (f) => this.GetInternalCache(tenant));
    //    }

    //    [UnitOfWork(scope: TransactionScopeOption.Suppress)]
    //    private Tenant GetInternalCache(Tenant tenant)
    //    {
    //        return this.tenantRepository.FirstOrDefault(tenant.Id);
    //    }
    //}
}
