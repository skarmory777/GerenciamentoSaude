...
namespace SW10.SWMANAGER.Web.Areas.Mpa.Models.Aplicacao.Faturamentos.ContasMedicas
{
    ...
    public class CriarOuEditarContaMedicaModalViewModel : FaturamentoContaDto
    {
        ...
        // se modal aberto via via atendimento
        public bool selecionarPrimeiraConta { get; set; }

        public bool IsEditMode
        {
            get { return this.Id > 0; }
        }
        public CriarOuEditarContaMedicaModalViewModel(FaturamentoContaDto output)
        {
            output.MapTo(this);
        }

        public CriarOuEditarContaMedicaModalViewModel(ContaMedicaViewModel output)
        {
            this.FatGuia = output.FatGuia.MapTo<FaturamentoGuiaDto>();
            this.Id = output.Id;
            ...
            this.TipoAcomodacaoDescricao = output.TipoLeitoDescricao;
            ...
            this.StatusId = output.StatusEntregaId;
            this.Id = output.Id;
