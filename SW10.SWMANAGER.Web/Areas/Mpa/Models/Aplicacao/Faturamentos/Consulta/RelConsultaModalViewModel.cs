...
namespace SW10.SWMANAGER.Web.Areas.Mpa.Models.Aplicacao.Faturamentos.Consulta
{
    [AutoMapFrom(typeof(FaturamentoContaDto))]
    //[AutoMapFrom(typeof(ContaMedicaViewModel))]
    public class RelConsultaModalViewModel : FaturamentoContaDto
    {
        ...
        public RelConsultaModalViewModel(FaturamentoContaDto output)
        {
            output.MapTo(this);
        }

        public RelConsultaModalViewModel(ContaMedicaViewModel output)
        {
            this.Id = output.Id;
