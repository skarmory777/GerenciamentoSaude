...
namespace SW10.SWMANAGER.Web.Areas.Mpa.Models.Aplicacao.Faturamentos.ResumuInternacao
{
    [AutoMapFrom(typeof(FaturamentoContaDto))]
    //[AutoMapFrom(typeof(ContaMedicaViewModel))]
    public class RelResumoInternacaoModalViewModel : FaturamentoContaDto
    {
        ...
        public RelResumoInternacaoModalViewModel(FaturamentoContaDto output)
        {
            output.MapTo(this);
        }

        public RelResumoInternacaoModalViewModel(ContaMedicaViewModel output)
        {
            this.Id = output.Id;
