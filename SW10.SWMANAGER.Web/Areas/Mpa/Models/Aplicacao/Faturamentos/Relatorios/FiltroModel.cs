...
namespace SW10.SWMANAGER.Web.Areas.Mpa.Models.Aplicacao.Faturamentos.Relatorios
{
    public class FiltroModel
    {
        ...
        public IList<FaturamentoContaItemReportModel> Itens { get; set; }
        //    public IList<Dictionary<string,string>> Lista { get; set; }
