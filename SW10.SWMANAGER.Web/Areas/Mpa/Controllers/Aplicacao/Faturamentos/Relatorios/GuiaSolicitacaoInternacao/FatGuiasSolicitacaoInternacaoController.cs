...
{
    public class FatGuiasSolicitacaoInternacaoController : SWMANAGERControllerBase
    {
        ...
        public async Task<ActionResult> CriarOuEditarModal(long? id)
        {
            ...
            if (id.HasValue)
            {
                model.AtendimentoIdTeste = id;
                //model = await _atendimentoAppService.Obter((long)id);
            }
            else
            {
                model.Id = 0;
            }
            return PartialView("~/Areas/Mpa/Views/Aplicacao/Faturamentos/SolicitacaoInternacao/_CriarOuEditarModal.cshtml", model);
        }
        ...
        public async Task<ActionResult> VisualizarSpsadt(GuiaSpsadtInput input)
        {
            ...
            using (var atendimentoAppService = IocManager.Instance.ResolveAsDisposable<IAtendimentoAppService>())
            {
                ...
                var conta = await contaMedicaAppService.Object.ObterReportModel((long)input.ContaId, atendimento.Id);
                ...
                try
                {
                    ...
                    GuiaSpsadt.LocalReport.ReportPath = string.Concat(Server.MapPath("~"), @"Relatorios\Faturamento\Guias\InternacaoSolicitacao\guia_internacao_solic.rdlc");
        ...
        public void SetParametrosSpsadt(ReportViewer rv, GuiaSpsadtModel dados)
        {
            ...
            ReportParameter CodigoCnes = new ReportParameter("CodigoCnes", "9999999");
            ...
            ReportParameter PrevOPME = new ReportParameter("PrevOPME", "4");
            ReportParameter PrevQuimio = new ReportParameter("PrevQuimio", "9");
            ReportParameter Cid1 = new ReportParameter("Cid1", "101");
            ReportParameter Cid2 = new ReportParameter("Cid2", "102");
            ReportParameter Cid3 = new ReportParameter("Cid3", "103");
            ReportParameter Cid4 = new ReportParameter("Cid4", "104");
            ///////////////////////////////////////////////////////////////////
