    ...
    $(function () {
        ...
        _$usersTable.jtable({
            ...
            fields: {
                ...
                actions: {
                    ...
                    display: function (data) {
                        ...
                        if (_permissions.impersonation && data.record.id != abp.session.userId) {
                            $('<button class="btn btn-default btn-xs" title="' + app.localize('LoginAsThisUser') + '"><i class="fa fa-sign-in-alt"></i></button>')
                                .appendTo($span)
                                .click(function () {
                                    abp.ajax({
                ...
                isHabilitaControleDeIp: {
                    title: app.localize('EnableIpControl'),
                    width: '6%',
                    display: function (data) {
                        if (data.record.isHabilitaControleDeIp == 1) {
                            return '<span class="label label-success">' + app.localize('Yes') + '</span>';
                        } else if (data.record.isHabilitaControleDeIp == 0) {
                            return '<span class="label label-default">' + app.localize('No') + '</span>';
                        } else {
                            return '<span class="label label-default">' + app.localize('Não definido') + '</span>';
                        }
                    }
                },
                lastLoginTime: {
