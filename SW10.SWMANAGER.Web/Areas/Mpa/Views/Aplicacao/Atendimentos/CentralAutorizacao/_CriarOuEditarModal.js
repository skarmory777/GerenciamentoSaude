...
(function ($) {
    $(function () {
        ...
        $('#salvar-autorizacaoProcedimento').click(function (e) {
            ...
            _autorizacaoProcedimento.criarOuEditarAutorizacaoProcedimento(autorizacaoProcedimento)
              .done(function (data) {
                  ...
                  if (data.errors.length > 0) {
                      ...
                      location.href = '/mpa/CentralAutorizacoes';
                  }
              })
                 .always(function () {
                 });
       ...
       ({
           ...
           fields:
           {
               ...
               FaturamentoItemDescricao: {
                   title: app.localize('Item'),
                   width: '30%',
                   display: function (data) {
                       if (data.record.FaturamentoItemDescricao) {
                           return data.record.FaturamentoItemDescricao;
                       }
                   }
               },
        ...
        function editAutorizacaoItem(autorizacaoItem) {
            ...
            $('#faturamentoItemId')
              ...
              .val(autorizacaoItem.FaturamentoItemId) //set value for option to post it
              .text(autorizacaoItem.FaturamentoItemDescricao)
            ) //set a text for show in select
      .val(autorizacaoItem.FaturamentoItemId) //select option of select2
            .trigger("change");
            ...
            if (autorizacaoItem.DataAutorizacao != '' && autorizacaoItem.DataAutorizacao != null) {
                ...
                $('#dataAutorizacaoId').val(moment(autorizacaoItem.DataAutorizacao).format('L'));
            }
            else {
            ...
            $('#isOrteseId').attr("checked", autorizacaoItem.IsOrtese);
            ...
            if ($('#idGrid').val() != '') {
                ...
                for (var i = 0; i < lista.length; i++) {
                    if (lista[i].IdGrid == $('#idGrid').val()) {
                        ...
                        lista[i].FaturamentoItemId = $('#faturamentoItemId').val();

                        var fatItem = $('#faturamentoItemId').select2('data');
                        if (fatItem && fatItem.length > 0) {

                            lista[i].FaturamentoItemDescricao = fatItem[0].text;
                        }
                        ...
                        lista[i].IsOrtese = $('#isOrteseId')[0].checked;
                ...
                autorizacaoItem.IsOrtese = $('#isOrteseId')[0].checked;
