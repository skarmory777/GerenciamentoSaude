...
<%@ Import Namespace="SW10.SWMANAGER.Web.Areas.Mpa.Models.Aplicacao.Atendimentos.Relatorios" %>
<!-- namespace para localizar FiltroModel-->
<%@ Import Namespace="SW10.SWMANAGER.Web.Relatorios.Atendimento" %>
        ...
        <div>
            <script runat="server">
                private void Page_Load(object sender, System.EventArgs e)
                {
                    ...
                    ReportViewer1.LocalReport.ReportPath = string.Concat(path, @"Relatorios\Atendimento\RelatorioAtendimento.rdlc");
