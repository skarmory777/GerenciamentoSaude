(function ($) {
    app.modals.ReativarAtendimentoModal = function () {
        ...
        this.save = function () {
            ...
            _AtendimentosService.reativar($('#atendimentoId').val(), $('#leitoId').val())
                .done(function () {
                  //  getAtendimentos();
        ...
        selectSW('.selectLeito', "/api/services/app/Leito/ListarLeitoVagoDropdown");
