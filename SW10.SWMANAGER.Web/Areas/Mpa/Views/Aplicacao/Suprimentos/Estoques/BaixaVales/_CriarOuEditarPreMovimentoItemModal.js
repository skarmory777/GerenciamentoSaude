(function ($) {
    app.modals.CriarOuEditarPreMovimentoItemModal = function () {
        ...
        var _estMovimentoBaixaService = abp.services.app.estMovimentoBaixa;
...
//            _$ItensValeTable.jtable('updateRecord', preMovimentoItem);    //{ clientOnly: true, registro: preMovimentoItem });
            ...
            _estMovimentoBaixaService.editar(preMovimentoItem)
                  .done(function (data) {

                      $('#totalDocumento').val(data.toLocaleString("pt-BR", { style: "currency", currency: "BRL" }).replace('R','').replace('$',''));
                   ...
                   //   else {
                     ...
                     //     if ( $('#Id').val() != undefined && $('#Id').val() != '')
                      ...
                      //    }
                          ...
                          abp.event.trigger('app.EditarBaixaValeItemModalSaved');
