(function () {
    ...
    $(function () {
        ...
        var _permissions = {
            create: abp.auth.hasPermission('Pages.Tenant.Suprimentos.Estoque.Emprestimo.Saida.Create'),
            edit: abp.auth.hasPermission('Pages.Tenant.Suprimentos.Estoque.Emprestimo.Saida.Edit'),
            'delete': abp.auth.hasPermission('Pages.Tenant.Suprimentos.Estoque.Emprestimo.Saida.Delete')
        };
        ...
        _$PreMovimentoTable.jtable({
            ...
            actions: {
                listAction: {
                    method: _preMovimentoService.listarEmprestimosSaida
                }
            },
                        ...
                        if (_permissions.edit) {
                            $('<button class="btn btn-default btn-xs" title="' + app.localize('Edit') + '"><i class="fa fa-edit"></i></button>')
                                ...
                                .click(function () {
                                    ...
                                    location.href = '/Mpa/Emprestimos/CriarOuEditarSaidaModal/' + data.record.id
                                });
                        }
        ...
        $('#CreateNewPreMovimentoButton').click(function () {
            location.href = '/mpa/emprestimos/CriarOuEditarSaidaModal/';
