(function ($) {
    $(function () {
        ...
        var _createOrEditPreMovimentoItemModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Mpa/EmprestimoBaixa/CriarOuEditarPreMovimentoItemModal',
            scriptUrl: abp.appPath + 'Areas/Mpa/Views/Aplicacao/Suprimentos/Estoques/Emprestimos/Baixa/CriarOuEditarItemModal/_CriarOuEditarPreMovimentoItemModal.js',
        ...
        $('.close-button').on('click', function () {
            location.href = '/mpa/EmprestimoBaixa';
        });
        ...
        function voltarAction() {
            if ($("#EstTipoOperacaoId").val() == 3) {
                location.href = '/mpa/EmprestimoBaixa/Concessao';
            } else if ($("#EstTipoOperacaoId").val() == 1) {
                location.href = '/mpa/EmprestimoBaixa/Recebimento';
            }            
        }
        ...
        function imprimir(id) {
            ...
            printJS({
                printable: '/Mpa/Solicitacao/imprimirSolicitacao?preMovimentoId=' + id,
                type: 'pdf',
                showModal: false,
                onPrintDialogClose: () => {
                    fecharAction();
