...
(function ($) {
    ...
    $(function () {
        ...
        var _createOrEditPreMovimentoItemModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Mpa/emprestimos/CriarOuEditarPreMovimentoItemSaidaModal',
            scriptUrl: abp.appPath + 'Areas/Mpa/Views/Aplicacao/Suprimentos/Estoques/Emprestimos/Saida/_CriarOuEditarPreMovimentoItemModal.js',
        ...
        $('#salvar-PreMovimento').click(function (e) {
            ...
            _preMovimentoService.criarOuEditarEmprestimoSaida(preMovimento)
                  .done(function (data) {
                          ...
                          _movimentoService.gerarMovimentoEntrada($('#id').val())
                              .done(function (data) {
                                  ...
                                  if (data.errors.length > 0) {
                                      ...
                                      abp.notify.info(app.localize('SavedSuccessfully'));
                                      location.href = '/mpa/emprestimos/saidas';
                                  }
                              });
                      }
