...
(function ($) {
    ...
    $(function () {
        ...
        var _createOrEditPreMovimentoItemModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Mpa/emprestimos/CriarOuEditarPreMovimentoItemEntradaModal',
            scriptUrl: abp.appPath + 'Areas/Mpa/Views/Aplicacao/Suprimentos/Estoques/Emprestimos/Entrada/_CriarOuEditarPreMovimentoItemModal.js',
        ...
        $('#btn-novo-PreMovimentoItem').click(function (e) {
            ...
            if ($('#id').val() == '' || $('#id').val() == '0') {
                ...
                _preMovimentoService.criarOuEditarEmprestimoEntrada(preMovimento)
                      .done(function (data) {
                          ...
                          _movimentoService.gerarMovimentoEntrada($('#id').val())
                              .done(function (data) {
                                  ...
                                  if (data.errors.length > 0) {
                                      ...
                                      abp.notify.info(app.localize('SavedSuccessfully'));
                                      location.href = '/mpa/emprestimos/entradas';
                                  }
                              });
                      }
                  })
        ...
        function abrirPreMovimentoItemLoteValidade(preMovimentoItem) {
            ...
            _createOrEditLoteValidadeProdutoModal.open({ preMovimentoItemId: preMovimentoItem.id, preMovimentoId: preMovimentoItem.preMovimentoId, produtoId: preMovimentoItem.produtoId });
        }
        ...
        $('#TipoAtendimentoId').on('change', function () {
            selectSWMultiplosFiltros('.selectAtendimento', "/api/services/app/atendimento/ListarAtendimentosEmAbertoDropdown", ['TipoAtendimentoId']);
        });
        ...
        selectSW('.selectEmprestimoEmpresa', "/api/services/app/sisPessoa/ListarDropdownPJ");
