(function () {
    ...
    $(function () {
        ...
        _$PreMovimentoTable.jtable({
            ...
            actions: {
                listAction: {
                    method: _preMovimentoService.listarDevolucoes
                }
            },
            ...
            fields: {
                        ...
                        if (_permissions.edit) {
                            $('<button class="btn btn-default btn-xs" title="' + app.localize('Edit') + '"><i class="fa fa-edit"></i></button>')
                                ...
                                .click(function () {
                                    ...
                                    location.href = 'Devolucoes/CriarOuEditarModal/' + data.record.id
                                });
                        }
                ...
                TipoSaida: {
                    title: app.localize('TipoDevolucao'),
                    width: '15%',
                    display: function (data) {
        ...
        $('#CreateNewPreMovimentoButton').click(function () {
            location.href = 'Devolucoes/CriarOuEditarModal/';
