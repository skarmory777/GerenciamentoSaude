(function ($) {
    app.modals.CriarOuEditarPreMovimentoItemModal = function () {
        ...
        this.save = function () {
            ...
            _preMovimentoItemService.criarOuEditarDevolucao(preMovimentoItem)
                .done(function (data) {
        ...
        function inserirProdutoCodigoBarra() {
            ...
            estoquePreMovimentoItemAppService.criarDevolucaoPorCodigoBarra($('#CodigoBarra').val(), $('#EstoqueId').val(), $('#PreMovimentoId').val(), $('#Quantidade').val())
                .done(function (data) {
                    debugger;
                    if (data.errors.length > 0) {
                        _ErrorModal.open({ erros: data.errors });
