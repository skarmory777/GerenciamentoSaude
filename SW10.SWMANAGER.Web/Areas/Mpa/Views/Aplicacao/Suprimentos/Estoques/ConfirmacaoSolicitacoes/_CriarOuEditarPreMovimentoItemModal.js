(function ($) {
    app.modals.CriarOuEditarPreMovimentoItemModal = function () {
        ...
        $('#inserir').on('click', function () {
            ...
            let preMovimentoItem = _preMovimentoItemForm.serializeFormToObject();

            const validarProdutoSaldo = {
                produtoId: $("#produtoId").val(),
                loteValidadeId: $("#loteValidadeId").val(),
                estoqueId: $("#EstoqueId").val(),
                isEntrada: $("#isEntrada").val(),
                quantidade: preMovimentoItem.quantidadeLote
            };
        ...
        function isSameLoteValidade(a, b) {
            let loteValidadeId = a.loteValidadeId || a.LoteValidadeId;
            let quantidadeLote = a.quantidadeLote || a.Quantidade;
            return (loteValidadeId == b.loteValidadeId && quantidadeLote == b.quantidade);
        }
        ...
        selectSWMultiplosFiltros('.loteValidade', '/api/services/app/EstoqueLoteValidade/ListarProdutoDropdownPorLaboratorio', ['produtoId', 'EstoqueId', 'LaboratorioId', 'loteValidadeId', 'isEntrada']);
