        ...
        <div>
            <script runat="server">
                private void Page_Load(object sender, System.EventArgs e)
                {
                    ...
                    ReportViewer1.LocalReport.ReportPath = "Relatorios/Suprimento/Estoque/Entrada.rdlc";
                    ...
                    ReportParameter fornecedor = new ReportParameter("Fornecedor", dados.Fornecedor);

                    ReportParameter documento = new ReportParameter("documento", dados.Documento);
                    ReportParameter CNPJFornecedor = new ReportParameter("CNPJFornecedor", dados.CNPJFornecedor);
                    ...
                    ReportParameter totalItens = new ReportParameter("TotalItens", dados.TotalItens);
                    ReportParameter valorFrete = new ReportParameter("ValorFrete", dados.ValorFrete);
                    ReportParameter valorTotal = new ReportParameter("ValorTotal", dados.ValorTotal);
                    ReportParameter isEntrada = new ReportParameter("IsEntrada", dados.IsEntrada? "S": "N");
