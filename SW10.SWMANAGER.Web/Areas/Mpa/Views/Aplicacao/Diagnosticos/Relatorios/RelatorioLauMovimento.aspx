...
<%@ Import Namespace="SW10.SWMANAGER.Web.Areas.Mpa.Models.Aplicacao.Diagnosticos.Relatorios" %>
<!-- namespace para localizar FiltroModel-->
<%@ Import Namespace="SW10.SWMANAGER.Web.Relatorios.Diagnostico" %>
        ...
        <div>
            <script runat="server">
                private void Page_Load (object sender, System.EventArgs e)
                {
                    ...
                    ReportViewer1.LocalReport.ReportPath = string.Concat(path, @"Relatorios\Diagnostico\LauMovimento.rdlc");
                    ...
                    if (dados != null)
                    {
                        ...
                        LauMovimentoDataSource relDS = new LauMovimentoDataSource();

                        // Iterando pelos milhares de dicionarios
                        foreach (var i in dados.ListaTotal)
                        {
                            DataTable tab = this.DicionarioParaTabela(i.Value, relDS.Tables["LauMovItemDataTable"], i.Key);
                            ReportDataSource dataSource = new ReportDataSource();
                            dataSource.Value = tab;
                            dataSource.Name = "LauMovimentoDataSet";
