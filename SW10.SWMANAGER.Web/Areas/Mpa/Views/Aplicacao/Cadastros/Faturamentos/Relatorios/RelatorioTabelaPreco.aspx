...
<%@ Import Namespace="SW10.SWMANAGER.Web.Areas.Mpa.Models.Aplicacao.Cadastros.Faturamento.Relatorios" %>
<!-- namespace para localizar FiltroModel-->
<%@ Import Namespace="SW10.SWMANAGER.Web.Relatorios.Faturamento" %>
        ...
        <div>
            <script runat="server">
                private void Page_Load(object sender, System.EventArgs e)
                {
                    ...
                    var dados = (FaturamentoFiltroModel)Model;
                    string path = HttpContext.Current.Server.MapPath("~");
                    ReportViewer1.LocalReport.ReportPath = string.Concat(path, @"Relatorios\Faturamento\RelatorioTabelaPreco.rdlc");
                    ...
                    if (dados != null)
                    {
                        ...
                        ReportParameter dataHora = new ReportParameter("DataHora", (dados.DataHora!=null)? dados.DataHora.ToString(): string.Empty);
                        ...
                        DsTabelaPreco relDS = new DsTabelaPreco();
                        DataTable tabela = this.ConvertToDataTable(dados.Lista, relDS.Tables["TabelaPrecoDs"]);
                        ReportDataSource dataSource = new ReportDataSource();
                        dataSource.Value = tabela;
                        dataSource.Name = "DataSetTabelaPreco";
