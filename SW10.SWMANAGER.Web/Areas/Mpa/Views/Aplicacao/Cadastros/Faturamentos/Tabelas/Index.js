(function () {
    $(function () {
        ...
        var _createOrEditModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Mpa/FaturamentoTabelas/CriarOuEditarModal',
            scriptUrl: abp.appPath + 'Areas/Mpa/Views/Aplicacao/Cadastros/Faturamentos/Tabelas/_CriarOuEditarModal.js',
            ...
            fields: {
                ...
                actions: {
                    ...
                    display: function (data) {
                        ...
                        if (_permissions.edit) {
                            $('<button class="btn btn-default btn-xs" title="' + app.localize('Relatorio') + '"><i class="fa fa-file-text-o"></i></button>')
                                .appendTo($span)
                                .click(function () {
                                    window.location.href = "/Mpa/FaturamentoRelatorio/Index/"+ data.record.id;
                                });
                        }
        ...
        function deleteTabelas(tabela) {
            ...
            abp.message.confirm(
                app.localize('DeleteWarning', tabela.descricao),
