(function () {
    $(function () {
        ...
        var _movimentoAutomaticoService = abp.services.app.movimentoAutomatico;
        var _$movimentoAutomaticoFilterForm = $('#movimentoAutomaticoFilterForm');

        var _permissions = {
            create: abp.auth.hasPermission('Pages.Tenant.Cadastros.Atendimento.MovimentosAutomaticos.Create'),
            edit: abp.auth.hasPermission('Pages.Tenant.Cadastros.Atendimento.MovimentosAutomaticos.Edit'),
            'delete': abp.auth.hasPermission('Pages.Tenant.Cadastros.Atendimento.MovimentosAutomaticos.Delete')
        };
        ...
        _$movimentoAutomaticoTable.jtable({
            ...
            title: app.localize('ListaMovimentoAutomatico'),
            paging: true,
            sorting: true,
            multiSorting: true,
                        ...
                        if (_permissions.edit) {
                            $('<button class="btn btn-default btn-xs" title="' + app.localize('Edit') + '"><i class="fa fa-edit"></i></button>')
                                ...
                                .click(function () {
                                    ...
                                    location.href = 'MovimentosAutomaticos/CriarOuEditarModal/' + data.record.id;
                                });
                        }
        ...
        $('#CreateNewButton').click(function () {
            location.href = 'MovimentosAutomaticos/CriarOuEditarModal/';
        });
