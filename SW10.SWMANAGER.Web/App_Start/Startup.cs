...
using SW10.SWMANAGER.Web;
using SW10.SWMANAGER.Web.Auth;
using SW10.SWMANAGER.WebApi.Controllers;
using System;
...
namespace SW10.SWMANAGER.Web
{
    public class Startup
    {
        ...
        public void Configuration(IAppBuilder app)
        {
            ...
            //GlobalHost.DependencyResolver.UseRedis("localhost", 6379, string.Empty, "signalrRedis");
            app.MapSignalR();
            ...
            //Enable it to use HangFire dashboard (uncomment only if it's enabled in SWMANAGERWebModule)
            //app.UseHangfireDashboard("/hangfire", new DashboardOptions
            //{
