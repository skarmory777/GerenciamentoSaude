    ...
    var handleSidebarAndContentHeight = function () {
        ...
        if (body.hasClass("page-footer-fixed") === true && body.hasClass("page-sidebar-fixed") === false) {
            ...
            if (content.height() < available_height) {
                content.css('min-height', available_height - parseFloat($('.page-container').css('padding-top')));
            }
        } else {
            ...
            content.css('min-height', height - parseFloat($('.page-container').css('padding-top')));
        }
    };
