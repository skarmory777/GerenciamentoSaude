...
{
    public static class ExtretDistDFeInt2
    {
        /// <summary>
        ...
        public static retDistDFeInt2 CarregarDeXmlString(this retDistDFeInt2 retDistDFeInt, string xmlString)
        {
            return FuncoesXml.XmlStringParaClasse<retDistDFeInt2>(xmlString);
        }
        ...
        public static string ObterXmlString(this retDistDFeInt2 retDistDFeInt)
        {
